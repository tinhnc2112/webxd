...
<link href="${contextPath}/resources/vendor/bootstrap/css/bootstrap.min.css"
	rel="stylesheet">
<link href="${contextPath}/resources/vendor/bootstrap-icons/bootstrap-icons.css"
	rel="stylesheet">
<link href="${contextPath}/resources/vendor/boxicons/css/boxicons.min.css"
	rel="stylesheet">
<link href="${contextPath}/resources/vendor/glightbox/css/glightbox.min.css"
	rel="stylesheet">
...
<body>
			...
			<nav id="navbar" class="navbar">
				<ul>
					...
					<li class="dropdown"><a href="#"><span>Lĩnh vực</span></a>
						<ul>
							<li class="dropdown"><a href="/project"><span>Dự
										án</span><i class="bi bi-chevron-down"></i></a></li>
							<li class="dropdown"><a href="#"><span>Kinh
										doanh, thương mại</span><i class="bi bi-chevron-down"></i></a>
								<ul>
	...
	<footer id="footer" data-aos="fade-up" data-aos-easing="ease-in-out"
			...
			<div class="container">
				<div class="row">
					<div class="col-lg-3 col-md-6 footer-contact">
						<h4>Contact Us</h4>
						<p>
							Số 66 Trần Liễu <br> Phường Thanh Bình<br> TP. Hải
							Dương<br>
							<br> <strong>Phone:</strong> 02203.831.216<br> <strong>Email:</strong>
							khanhtuky6886@gmail.com<br>
						</p>
					...
					<div class="col-lg-3 col-md-6 footer-info">
						<h3>THÀNH ĐẠT.TK</h3>
						<p>Cung cấp ra những dịch vụ, giá trị mang tính cốt lõi hướng
							tói lợi ích tốt nhất cho khách hàng là định hướng phát triển của
							Công ty.</p>
		...
		<div class="container">
			<div class="copyright">
				&copy; Copyright <strong><span>CO</span></strong>. All Rights
				Reserved
			</div>
			<div class="credits">
