                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div style="margin-left: 5px;width: 40%;float: left;">
                                                ...
                                                <a href="${editURL}" style="font-size: 25px;"><i class="glyphicon glyphicon-pencil"></i></a>
                                            </div>
                                            <div style="width: 40%;float: left">
                                            <spring:url value="/nhansu/delete/${nhansu.idNhanSu}" var="deleteURL" /> <a href="${deleteURL}" style="font-size: 25px;"
                                                                      onclick="return confirm('Bạn chắc chắn xoá nhân sự có tên : ${nhansu.name} ?');"><i class="glyphicon glyphicon-trash"></i> </a>
                                            </div>
                                        </td>
                                    </tr>
                                </c:forEach>
