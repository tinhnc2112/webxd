                ...
                <div class="col-xs-12">
                    <div class="box">
                        <div class="box-header">
                            <h3 class="box-title">Bản dữ liệu Dự án</h3>
                        </div>
                        <div class="box-header">
                            <spring:url value="/save" var="addURL" />
                            <a class="btn btn-primary" href="${addURL}" role="button"><i
                                    class="glyphicon glyphicon-plus"></i> Thêm Dự án</a>
                        </div>
                        ...
                        <div class="box-body">
                            <table id="example1" class="table table-bordered table-striped">
                                ...
                                <tbody>
                                <c:forEach items="${listDuAn}" var="duan" varStatus="s">
                                    <tr>
                                        <td><c:out value="${s.index + 1}" /></td>
                                        <td><c:out value="${duan.name}" /></td>
                                        <td><c:out value="${duan.address}" /></td>
                                        <td><c:out value="${duan.endDate}"></c:out> </td>                                         
                                        <td><img src="/user-photos/${duan.photo}" class="img-circle" alt="User Image" width="150px" height="100px"></td>
                                        <td><c:out value="${duan.description}"></c:out></td>
                                        <td>
                                            <div style="margin-left: 5px;width: 40%;float: left;">
                                                <spring:url
                                                        value="/duan/${duan.idDuAn}/edit" var="editURL" />
                                                <a href="${editURL}" style="font-size: 25px;"><i
                                                        class="glyphicon glyphicon-pencil"></i></a>
                                            </div>
                                            <div style="width: 40%;float: left">
                                            <spring:url value="/duan/delete/${duan.idDuAn}" var="deleteURL" /> <a href="${deleteURL}" style="font-size: 25px;"
                                                                      onclick="return confirm('Bạn chắc chắn xoá dự án có tên : ${duan.name} ?');"><i
